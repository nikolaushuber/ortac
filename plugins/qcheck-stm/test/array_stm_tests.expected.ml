...
module Spec =
  struct
    ...
    let precond cmd__050_ state__051_ =
      ...
      | Length ->
          let state__051_ = Model.adjust state__051_ 1 in
          let t_1__052_ = Model.get state__051_ 0 in true
      | Get i ->
          let state__051_ = Model.adjust state__051_ 1 in
          let t_2__053_ = Model.get state__051_ 0 in true
      | Set (i_1, a_1) ->
          let state__051_ = Model.adjust state__051_ 1 in
          let t_3__054_ = Model.get state__051_ 0 in true
      | Fill (i_2, j, a_2) ->
          let state__051_ = Model.adjust state__051_ 1 in
          let t_4__055_ = Model.get state__051_ 0 in true
      | To_list ->
          let state__051_ = Model.adjust state__051_ 1 in
          let t_5__056_ = Model.get state__051_ 0 in true
      | Mem a_3 ->
          let state__051_ = Model.adjust state__051_ 1 in
          let t_6__057_ = Model.get state__051_ 0 in true
            ...
            ((result char exn),
              ((SUT.adjust sut__059_ 1;
                (let t_2__062_ = SUT.pop sut__059_ in
                 ...
                 SUT.push t_2__062_ sut__059_; res__063_))))
      | Set (i_1, a_1) ->
          Res
            ((result unit exn),
              ((SUT.adjust sut__059_ 1;
                (let t_3__064_ = SUT.pop sut__059_ in
                 ...
                 SUT.push t_3__064_ sut__059_; res__065_))))
      | Fill (i_2, j, a_2) ->
          Res
            ((result unit exn),
              ((SUT.adjust sut__059_ 1;
                (let t_4__066_ = SUT.pop sut__059_ in
                 ...
                 SUT.push t_4__066_ sut__059_; res__067_))))
      | To_list ->
          Res
            ((list char),
              ((SUT.adjust sut__059_ 1;
                (let t_5__068_ = SUT.pop sut__059_ in
                 ...
                 SUT.push t_5__068_ sut__059_; res__069_))))
      | Mem a_3 ->
          Res
            (bool,
              ((SUT.adjust sut__059_ 1;
                (let t_6__070_ = SUT.pop sut__059_ in
                 ...
                 SUT.push t_6__070_ sut__059_; res__071_))))
  end
  ...
  let open Spec in
    let open STM in
      ...
      | (Length, Res ((Int, _), i_3)) ->
          let state__023_ = Model.adjust state__023_ 1 in
          if
