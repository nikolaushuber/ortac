...
module Spec =
  struct
    ...
    let precond cmd__015_ state__016_ =
      ...
      | Set (i_1, a_2) ->
          let state__016_ = Model.adjust state__016_ 1 in
          let t_1__017_ = Model.get state__016_ 0 in true
