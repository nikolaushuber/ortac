...
module Spec =
  struct
    ...
    let precond cmd__012_ state__013_ =
      ...
      | Push a_1 ->
          let state__013_ = Model.adjust state__013_ 1 in
          let t_1__014_ = Model.get state__013_ 0 in true
