  ...
  struct
    ...
    let next_state cmd__004_ state__005_ =
      ...
      | Append ->
          ...
          Model.push
            (Model.push (Model.push (Model.drop_n state__005_ 2) b__040_)
               a_1__041_) t_14__039_
      | Sub (i_6, n_1) ->
          ...
          then
            ...
            Model.push (Model.push (Model.drop_n state__005_ 1) t_15__045_)
              r__044_
          else state__005_
      | Copy ->
          let t_16__050_ = Model.get state__005_ 0 in
          let t_16__053_ = t_16__050_
          and r_1__052_ =
            let open ModelElt in
              {
                contents =
          ...
          Model.push (Model.push (Model.drop_n state__005_ 1) t_16__053_)
            r_1__052_
      | Fill (pos, len, x_4) ->
