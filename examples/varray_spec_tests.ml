  ...
  struct
    ...
    let show_cmd cmd__003_ =
      ...
      | Blit (src_pos, dst_pos, len_1) ->
          Format.asprintf "protect (fun () -> %s sut %a sut %a %a)" "blit"
            (Util.Pp.pp_int true) src_pos (Util.Pp.pp_int true) dst_pos
    ...
    let next_state cmd__004_ state__005_ =
      ...
      | Push_back x ->
          let state__005_ = Model.adjust state__005_ 1 in
      ...
      | Blit (src_pos, dst_pos, len_1) ->
          let state__005_ = Model.adjust state__005_ 2 in
          let dst__040_ = Model.get state__005_ 0
          and src__041_ = Model.get state__005_ 1 in
          if
            (try
               let __t1__044_ =
                 Ortac_runtime.Gospelstdlib.(<=)
          ...
          then
            ...
            and src__043_ = src__041_ in
            Model.push (Model.push (Model.drop_n state__005_ 2) src__043_)
              dst__042_
          else state__005_
    let precond cmd__108_ state__109_ =
      match cmd__108_ with
      | Push_back x ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_1__110_ = Model.get state__109_ 0 in true
      | Pop_back ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_2__111_ = Model.get state__109_ 0 in true
      | Push_front x_1 ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_3__112_ = Model.get state__109_ 0 in true
      | Pop_front ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_4__113_ = Model.get state__109_ 0 in true
      | Insert_at (i_1, x_2) ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_5__114_ = Model.get state__109_ 0 in true
      | Pop_at i_2 ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_6__115_ = Model.get state__109_ 0 in true
      | Delete_at i_3 ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_7__116_ = Model.get state__109_ 0 in true
      | Get i_4 ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_8__117_ = Model.get state__109_ 0 in true
      | Set (i_5, v) ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_9__118_ = Model.get state__109_ 0 in true
      | Length ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_10__119_ = Model.get state__109_ 0 in true
      | Is_empty ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_11__120_ = Model.get state__109_ 0 in true
      | Fill (pos, len, x_3) ->
          let state__109_ = Model.adjust state__109_ 1 in
          let t_12__121_ = Model.get state__109_ 0 in true
      | Blit (src_pos, dst_pos, len_1) ->
          let state__109_ = Model.adjust state__109_ 2 in
          let dst__122_ = Model.get state__109_ 0
          and src__123_ = Model.get state__109_ 1 in true
            ...
            ((result (elt char) exn),
              ((SUT.adjust sut__125_ 1;
                (let t_2__128_ = SUT.pop sut__125_ in
                 ...
                 SUT.push t_2__128_ sut__125_; res__129_))))
      | Push_front x_1 ->
          Res
            (unit,
              ((SUT.adjust sut__125_ 1;
                (let t_3__130_ = SUT.pop sut__125_ in
                 ...
                 SUT.push t_3__130_ sut__125_; res__131_))))
      | Pop_front ->
          Res
            ((result (elt char) exn),
              ((SUT.adjust sut__125_ 1;
                (let t_4__132_ = SUT.pop sut__125_ in
                 ...
                 SUT.push t_4__132_ sut__125_; res__133_))))
      | Insert_at (i_1, x_2) ->
          Res
            ((result unit exn),
              ((SUT.adjust sut__125_ 1;
                (let t_5__134_ = SUT.pop sut__125_ in
                 ...
                 SUT.push t_5__134_ sut__125_; res__135_))))
      | Pop_at i_2 ->
          Res
            ((result (elt char) exn),
              ((SUT.adjust sut__125_ 1;
                (let t_6__136_ = SUT.pop sut__125_ in
                 ...
                 SUT.push t_6__136_ sut__125_; res__137_))))
      | Delete_at i_3 ->
          Res
            ((result unit exn),
              ((SUT.adjust sut__125_ 1;
                (let t_7__138_ = SUT.pop sut__125_ in
                 let res__139_ =
                   protect (fun () -> delete_at t_7__138_ i_3) () in
                 SUT.push t_7__138_ sut__125_; res__139_))))
      | Get i_4 ->
          Res
            ((result (elt char) exn),
              ((SUT.adjust sut__125_ 1;
                (let t_8__140_ = SUT.pop sut__125_ in
                 ...
                 SUT.push t_8__140_ sut__125_; res__141_))))
      | Set (i_5, v) ->
          Res
            ((result unit exn),
              ((SUT.adjust sut__125_ 1;
                (let t_9__142_ = SUT.pop sut__125_ in
                 ...
                 SUT.push t_9__142_ sut__125_; res__143_))))
      | Length ->
          Res
            (int,
              ((SUT.adjust sut__125_ 1;
                (let t_10__144_ = SUT.pop sut__125_ in
                 ...
                 SUT.push t_10__144_ sut__125_; res__145_))))
      | Is_empty ->
          Res
            (bool,
              ((SUT.adjust sut__125_ 1;
                (let t_11__146_ = SUT.pop sut__125_ in
                 ...
                 SUT.push t_11__146_ sut__125_; res__147_))))
      | Fill (pos, len, x_3) ->
          Res
            ((result unit exn),
              ((SUT.adjust sut__125_ 1;
                (let t_12__148_ = SUT.pop sut__125_ in
                 ...
                 SUT.push t_12__148_ sut__125_; res__149_))))
      | Blit (src_pos, dst_pos, len_1) ->
          Res
            ((result unit exn),
              ((SUT.adjust sut__125_ 2;
                (let dst__151_ = SUT.pop sut__125_ in
                 let src__150_ = SUT.pop sut__125_ in
                 let res__152_ =
                   protect
                     (fun () ->
                        blit src__150_ src_pos dst__151_ dst_pos len_1) () in
                 SUT.push src__150_ sut__125_;
                 SUT.push dst__151_ sut__125_;
                 res__152_))))
  end
  ...
  let open Spec in
    let open STM in
      ...
      | (Push_back x, Res ((Unit, _), _)) ->
          let state__053_ = Model.adjust state__053_ 1 in None
      | (Pop_back, Res ((Result (Elt (Char), Exn), _), x_4)) ->
          let state__053_ = Model.adjust state__053_ 1 in
          (match x_4 with
           | Ok x_4 ->
               if
      ...
      | (Blit (src_pos, dst_pos, len_1), Res ((Result (Unit, Exn), _), res))
          ->
          let state__053_ = Model.adjust state__053_ 2 in
