...
module Spec =
  struct
    ...
    let precond cmd__055_ state__056_ =
      ...
      | Is_empty ->
          let state__056_ = Model.adjust state__056_ 1 in
          let s__057_ = Model.get state__056_ 0 in true
      | Length ->
          let state__056_ = Model.adjust state__056_ 1 in
          let s_1__058_ = Model.get state__056_ 0 in true
      | Add_l a_1 ->
          let state__056_ = Model.adjust state__056_ 1 in
          let s_2__059_ = Model.get state__056_ 0 in true
      | Add_r a_2 ->
          let state__056_ = Model.adjust state__056_ 1 in
          let s_3__060_ = Model.get state__056_ 0 in true
      | Take_l ->
          let state__056_ = Model.adjust state__056_ 1 in
          let s_4__061_ = Model.get state__056_ 0 in true
      | Take_r ->
          let state__056_ = Model.adjust state__056_ 1 in
          let s_5__062_ = Model.get state__056_ 0 in true
      | Take_opt_l ->
          let state__056_ = Model.adjust state__056_ 1 in
          let s_6__063_ = Model.get state__056_ 0 in true
      | Take_opt_r ->
          let state__056_ = Model.adjust state__056_ 1 in
          let s_7__064_ = Model.get state__056_ 0 in true
            ...
            (int,
              ((SUT.adjust sut__066_ 1;
                (let s_1__069_ = SUT.pop sut__066_ in
                 ...
                 SUT.push s_1__069_ sut__066_; res__070_))))
      | Add_l a_1 ->
          Res
            ((node int),
              ((SUT.adjust sut__066_ 1;
                (let s_2__071_ = SUT.pop sut__066_ in
                 ...
                 SUT.push s_2__071_ sut__066_; res__072_))))
      | Add_r a_2 ->
          Res
            ((node int),
              ((SUT.adjust sut__066_ 1;
                (let s_3__073_ = SUT.pop sut__066_ in
                 ...
                 SUT.push s_3__073_ sut__066_; res__074_))))
      | Take_l ->
          Res
            ((result int exn),
              ((SUT.adjust sut__066_ 1;
                (let s_4__075_ = SUT.pop sut__066_ in
                 ...
                 SUT.push s_4__075_ sut__066_; res__076_))))
      | Take_r ->
          Res
            ((result int exn),
              ((SUT.adjust sut__066_ 1;
                (let s_5__077_ = SUT.pop sut__066_ in
                 ...
                 SUT.push s_5__077_ sut__066_; res__078_))))
      | Take_opt_l ->
          Res
            ((option int),
              ((SUT.adjust sut__066_ 1;
                (let s_6__079_ = SUT.pop sut__066_ in
                 ...
                 SUT.push s_6__079_ sut__066_; res__080_))))
      | Take_opt_r ->
          Res
            ((option int),
              ((SUT.adjust sut__066_ 1;
                (let s_7__081_ = SUT.pop sut__066_ in
                 ...
                 SUT.push s_7__081_ sut__066_; res__082_))))
  end
  ...
  let open Spec in
    let open STM in
      ...
      | (Is_empty, Res ((Bool, _), b)) ->
          let state__022_ = Model.adjust state__022_ 1 in
          if
      ...
      | (Add_l a_1, Res ((Node (Int), _), n)) ->
          let state__022_ = Model.adjust state__022_ 1 in None
      | (Add_r a_2, Res ((Node (Int), _), n_1)) ->
          let state__022_ = Model.adjust state__022_ 1 in None
